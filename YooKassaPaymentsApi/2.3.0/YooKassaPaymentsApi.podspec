Pod::Spec.new do |s|
  ...
  s.version   = '2.3.0'
  s.homepage  = 'https://git.yoomoney.ru/projects/SDK/repos/yookassa-payments-api-swift/browse'
  s.license   = {
    :type => "MIT",
    :file => "LICENSE"
  }
  ...
  s.source = { :git => 'https://git.yoomoney.ru/scm/sdk/yookassa-payments-api-swift.git', :tag => '2.3.0' }
